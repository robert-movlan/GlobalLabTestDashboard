  ...
  useEffect(() => {
    ...
    axios.get('/db.json')
      .then(response => {
        ...
        // ⏳ Wait 5 seconds before removing the spinner
        setTimeout(() => {
          setLoading(false);
        }, 5000);
      })
      .catch(error => {
        ...
        setTimeout(() => {
          setLoading(false); // stop spinner after 5 seconds on error too
        }, 5000);
      });
  }, []);
  ...
  if (loading) {
    return (
      <div className="custom-spinner">
        ...
        <div className="loading-text">Loading Lab Test Data...</div>
      </div>
    );
  }  
